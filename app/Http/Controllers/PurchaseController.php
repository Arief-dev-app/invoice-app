...
class PurchaseController extends BaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $purchase = Purchase::with('suplier', 'purchase')
        ...
        $pos = PurchaseOrder::where('po_status', 3)->get();
        $suppliers = Supplier::all();

        $menus = $this->getAccessibleMenus();
        $default = $this->data();

        return view('admin.transaksi.transaksi-pembelian.index', array_merge($default, [
            'purchase'     => $purchase, 
            'search'       => $search, 
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $purchaseNo = $this->generateAutoNumber(Purchase::class, 'trans_no', 'PRC');
    ...
    {
        $purchase = Purchase::with('detail.prd')->findOrFail($id);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $po = Purchase::findOrFail($id); // pastikan $id adalah ID PO yang akan diupdate
            ...
            // Hapus detail lama
            PurchaseDetail::where('trans_id', $po->id)->delete();
    ...
    {
        $po = PurchaseOrder::with(['detail.prd', 'suplier'])->find($id);
    ...
    public function confirm($id)
    {
        try {
            ...
            $details = PurchaseDetail::where('trans_id', $purchase->id)->get();
            ...
            foreach ($details as $value) {
                ...
                if ($prd) {
                    ...
                    $hargaBeliBaru = $value->harga;
                    $hargaJualBaru = $hargaBeliBaru * 1.10; 
