<div class="px-4 py-6">
    <div class="bg-white shadow rounded p-6">
        <div class="flex justify-between items-center mb-4">
            ...
            <button onclick="handleAddGroupClick('Tambah Customer')" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">+ Tambah {{ $title }}</button>
        </div>
        ...
        <div class="flex items-center justify-between mb-4">
            <form method="GET" class="flex gap-2 items-center">
                <input type="text" id="searchInput" name="search" placeholder="Cari nama customer..." class="border rounded px-3 py-2 w-full sm:w-64">
