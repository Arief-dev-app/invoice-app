...
<div id="globalModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
    <div class="bg-white p-6 rounded shadow-lg w-full max-w-lg">
        ...
        <form id="productForm" method="POST">
            ...
            <div class="mb-4">
                <label for="formHargaBeli" class="block text-sm font-medium">Harga Beli</label>
                <input type="number" name="harga_beli" id="formHargaBeli" class="w-full border rounded px-3 py-2">
            </div>

            <div class="mb-4">
                <label for="formHargaJual" class="block text-sm font-medium">Harga Jual</label>
                <input type="number" name="harga_jual" id="formHargaJual" class="w-full border rounded px-3 py-2">
            </div>
